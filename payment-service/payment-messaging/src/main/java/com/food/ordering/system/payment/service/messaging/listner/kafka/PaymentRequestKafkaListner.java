package com.food.ordering.system.payment.service.messaging.listner.kafka;

import com.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus;
import com.food.ordering.system.kafka.consumer.KafkaConsumer;
import com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel;
import com.food.ordering.system.payment.service.domain.PaymentRequestMessageListenerImpl;
...
@Slf4j
@Component
public class PaymentRequestKafkaListner implements KafkaConsumer<PaymentRequestAvroModel> {

    private final PaymentRequestMessageListener paymentRequestMessageListener;
    private final PaymentMessagingDataMapper paymentMessagingDataMapper;

    public PaymentRequestKafkaListner(PaymentRequestMessageListener paymentRequestMessageListener,
